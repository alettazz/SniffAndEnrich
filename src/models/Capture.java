...
public class Capture {
    ...
    public Capture(String id, String time, String sourceMAC, String destinationMAC, String protocol, String rssi, String deltaTime, String captureType, String sourceManufacturer, String sourceModel, String sourceType, String wlanSSID) {
        this.id = id.substring(1, id.length() - 1);
        this.time = convertTimeToDate(time.substring(1, time.length() - 1));
        this.sourceMAC = sourceMAC.substring(1, sourceMAC.length() - 1);
        this.destinationMAC = destinationMAC.substring(1, destinationMAC.length() - 1);
    ...
    public Capture(String id, String time, String sourceMAC, String destinationMAC, String protocol, String rssi, String deltaTime, String captureType, String sourceManufacturer, String sourceModel, String sourceType, String wlanSSID, String dataRate) {
        this.id = id;
        this.time = convertTimeToDate(time);
