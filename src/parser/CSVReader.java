...
import src.models.Probe;
import src.models.ProbeActivity;
import src.models.Trilat;
...
public class CSVReader {
    ...
    private static void calibrateLatLngWithHeatmaps(List<Trilat> listOfTrilatDistances) {

        HashMap<String, List<Trilat>> rssiHeatmap = RequestResponseParser.getRssiHeatmap();

        for (Trilat listOfTrilatDistance : listOfTrilatDistances) {
            double rssi = listOfTrilatDistance.getRssi();
            rssiHeatmap.put(String.valueOf(rssi), listOfTrilatDistances);
        }
